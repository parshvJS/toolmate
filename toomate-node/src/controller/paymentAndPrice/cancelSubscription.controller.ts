...
async function cancelPaypalSubscription(subscriptionId: string, accessToken: string) {
    ...
    await axios.post(`${BASE_API_URL}/v1/billing/subscriptions/${subscriptionId}/cancel`, {
...
export async function cancelSubscription(req: Request, res: Response) {
    ...
    try {
        ...
        const paypalData = await cancelPaypalSubscription(subscriptionId, accessToken);
        ...
        await logCancellation(subscriptionId, paypalData.status);
