	...
	theme: {
		extend: {
			...
			keyframes: {
				gradientShift: {
					'0%': {
						background: 'linear-gradient(to right, #FFD700, #FF5900)'
					},
					'100%': {
						background: 'linear-gradient(to right, #FF5900, #FFD700)'
					}
				},
				fadeIn: {
					'0%': {
			...
			fontSize: {
				base: '0.95rem', // Adjust this value for your desired large font size
			},
		}
	},
	plugins: [
