  ...
  const largeFeatureCardsContent = [
    {
      ...
      windowExampleImage: "/public/assets/images/yellow-bg.png",
      CTA: "Find People Like You",
      lineBelowSection: true,
      featuresList: [
        {
          icon: "/public/assets/icons/orageGrid.svg",
          title: "Creative Workshop",
          desc: "Boost Your Projects with Tailored Ideas and Support",
          lineBelow: true,
        },
        {
          icon: "/public/assets/icons/orangeMoon.svg",
          title: "Pro Guidance",
    ...
    },
    {
      ...
      featuresList: [
        {
          icon: "/public/assets/icons/orangePencil.svg",
        ...
        {
          icon: "/public/assets/icons/orangeTick.svg",
